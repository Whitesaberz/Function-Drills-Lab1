...
let nameCheck = (here) => {
  if((here) === 'Steven'){
    ...
    return `Cool name, ${here}
  `}
}
let nameGreeting = nameCheck('Woody')
...
let bestMovie = (movie) => {return `${movie} is the best movie ever!`}; let Film = bestMovie("The Dark Knight"); console.log(Film)
